...
import type { TestimonioComment } from '@/lib/testimonios';
...
export default function DetalleTestimonioScreen() {
  ...
  const { testimonios, getTestimonioById, toggleTestimonioSave, likeTestimonio, unlikeTestimonio } = useAppStore();
