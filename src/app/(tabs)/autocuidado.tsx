...
const GROUP_CATEGORIES = ['Rutinas', 'Hábitos', 'Meditación', 'Bienestar', 'Sueño', 'Límites', 'Autocuidado'];

export default function AutocuidadoScreen() {
      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <ThemedText type="small" themeColor="textSecondary" style={styles.pageDesc}>
            Rutinas y prácticas para nutrir tu bienestar personal, cuidar tu cuerpo y dar prioridad a tu tranquilidad interior.
          </ThemedText>
        </View>
