...
export const communities: Community[] = [
  ...
  },
  {
    id: '5',
    name: 'Maternidad',
    description: 'Comparte experiencias, dudas y alegrías del camino de ser madre.',
    image: 'https://images.unsplash.com/photo-1522338242992-e1a54906a8da?auto=format&fit=crop&w=900&q=80',
  },
  {
    id: '6',
    name: 'Emprendimiento',
    description: 'Impulsa tus ideas de negocio con el apoyo de otras mujeres emprendedoras.',
